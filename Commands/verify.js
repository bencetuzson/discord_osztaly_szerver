    ...
    async execute(message, args){
        ...
        switch (args[1]) {
            ...
            case "done":
                ...
                break;
            case "verify":
                title = `Elfogadod a ${message.guild.channels.cache.get(setup.REACTION_ROLES.Tartsuk_be_legyszi.CHANNEL_ID)}ben leírtakat?`;
                description = `**Ha igen, attints az ez alatt lévő :white_check_mark:-ra, és menj be a ${message.guild.channels.cache.get(setup.REACTION_ROLES.Ezek_erdekelnek.CHANNEL_ID)} csatornába (vagy nyomj rá a \`#ezek-érdekelnek\`-re!)!**`;
